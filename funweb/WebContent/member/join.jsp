...
function check(){
	...
	if(document.frm.passwd.calue != document.frm.passwd2.calue){
...
<label>User ID</label> <input name="id" type="text" class="id" id="id"> <input name="" type="button" value="아이디 중복확인" class="dup" onclick="winOpen();"><br>
